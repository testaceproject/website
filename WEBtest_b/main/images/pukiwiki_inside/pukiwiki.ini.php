...
$page_title = 'ACE Project PukiWiki';
...
$modifier = 'ace-project';

// Site admin's Web page (CHANGE THIS)
$modifierlink = 'http://ace-project.kyushu-u.ac.jp/pukiwiki/';

// Default page name
$defaultpage  = 'Ace-Project Wiki';     // Top / Default page
...
// Default: always fail
$adminpass = '{x-php-md5}'. md5('pet@t0ex@');
